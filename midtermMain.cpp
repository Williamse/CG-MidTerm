...
bool keyTyped(enum sf::Keyboard::Key key)
{
	...
	case sf::Keyboard::C:  displayNumber = 2;  break;	// clip
	case sf::Keyboard::P:  displayNumber = 1;  break;	// polygon
	case sf::Keyboard::T:  displayNumber = 3;  break;	// transform
	case sf::Keyboard::V:  displayNumber = 0;  break;	// viewport
